...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/AliPlayerPartSDK_iOS/AliyunPlayer.framework"
  install_framework "${PODS_ROOT}/AliPlayerPartSDK_iOS/AliyunMediaDownloader.framework"
  ...
  install_framework "${PODS_ROOT}/AliyunVideoSDKBasic/AliyunVideoCore.framework"
